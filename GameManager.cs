...
public class GameManager
{
    ...
    public void EndTurn()
    {
        ...
        Debug.Log("End turn function, check if all players has acted in this phase");
        // Check if all players have acted in this phase
        if (listOfPlayers.All(player => player.hasActed || !player.isActive))
        {
            currentBet = minimumBet;
            Debug.Log("End turn function, Check success");
            currentPhase++;
        ...
        {
            Debug.Log("End turn function, check failed");
    ...
    {
        Debug.Log("Starting the Flop phase!");
        ...
        // Log the community cards to the console
        Debug.Log($"Flop cards: {string.Join(", ", communityCards.Select(card => card.ToString()))}");
    ...
    {
        Debug.Log("Starting the Turn phase!");
    ...
    {
        Debug.Log("Starting the River phase!");
