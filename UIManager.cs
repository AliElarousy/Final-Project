...
public class UIManager : MonoBehaviour
{
    ...
    private void updateHighestRankText()
    {
        ...
        Debug.Log(gameManager.listOfPlayers[0].hand.Count);
    }
    ...
    {
        Debug.Log("drawCommunityCards for "+phase+" phase");
    ...
    {
        Debug.Log("Handle phase change function call: "+phase);
    ...
    private void handleStartTurn()
    {
        ...
        Debug.Log("Handle startTurn function");
        ...
        if (!gameManager.listOfPlayers[gameManager.currentPlayerIndex].isNpc)
        {
            ...
            raiseButton.GetComponentInChildren<TextMeshProUGUI>().text = "RAISE \n" + gameManager.listOfPlayers[0].selectedRaiseValue.ToString();
    ...
    {
        Debug.Log("Handle endTurn function");
        if (!gameManager.listOfPlayers[gameManager.currentPlayerIndex].isNpc)
        {
    ...
    void incrementRaise()
    {
        ...
        raiseButton.GetComponentInChildren<TextMeshProUGUI>().text = "RAISE \n" + (gameManager.listOfPlayers[gameManager.currentPlayerIndex].selectedRaiseValue).ToString();
